...
const steps = [
    {
        ...
        description:
            'Parcourez notre catalogue de cours en mindfulness, chakras, yoga et bien-être, filtrés par thème et niveau.',
    },
    {
        number: '02',
        icon: UserPlus,
    ...
    },
    {
        number: '04',
        icon: Sparkles,
        title: 'Transformez-vous',
        description:
            'Appliquez les pratiques dans votre quotidien et constatez les changements profonds dans votre bien-être.',
    },
] as const;
            ...
            <div className="relative mx-auto max-w-7xl px-6 md:px-8 lg:px-12">
                ...
                >
                    ...
                    <h2 className="mb-4 text-3xl font-semibold tracking-tight text-foreground md:text-5xl">
                        Commencer votre parcours bien-être est simple
                    </h2>

                    <p className="mx-auto max-w-2xl text-lg text-foreground/60">
                        En quelques étapes, accédez à des formations de qualité
                        en mindfulness et bien-être, et progressez à votre
                        rythme vers un équilibre durable.
                    </p>
                </motion.div>
